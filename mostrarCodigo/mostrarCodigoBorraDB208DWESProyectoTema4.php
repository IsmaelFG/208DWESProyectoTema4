...
<html lang="en">
    <head>
        ...
        <title>BorraDB208DWESProyectoTema4</title>
    ...
    <body style="margin-top:70px">
        <nav class="navbar navbar-expand-lg bg-primary fixed-top">
            <div class="container">
                <a class="navbar-brand text-white" href="/index.html">BorraDB208DWESProyectoTema4</a>
        ...
        <?php
        show_source($filename = "../scriptDB/BorraDB208DWESProyectoTema4.sql");
        ?>
