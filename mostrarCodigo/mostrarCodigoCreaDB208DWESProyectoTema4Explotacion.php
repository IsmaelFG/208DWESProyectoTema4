...
<html lang="en">
    <head>
        ...
        <title>mostrarCodigoCreaDB208DWESProyectoTema4Explotacion</title>
    ...
    <body style="margin-top:70px">
        <nav class="navbar navbar-expand-lg bg-primary fixed-top">
            <div class="container">
                <a class="navbar-brand text-white" href="/index.html">CreaDB208DWESProyectoTema4Explotacion</a>
        ...
        <?php
        show_source($filename = "../scriptDB/CreaDB208DWESProyectoTema4Explotacion.php");
        ?>
