...
<html lang="en">
    <head>
        ...
        <title>mostrarCodigoCargaInicialDB208DWESProyectoTema4</title>
    ...
    <body style="margin-top:70px">
        <nav class="navbar navbar-expand-lg bg-primary fixed-top">
            <div class="container">
                <a class="navbar-brand text-white" href="/index.html">CargaInicialDB208DWESProyectoTema4</a>
        ...
        <?php
        show_source($filename = "../scriptDB/CargaInicialDB208DWESProyectoTema4.sql");
        ?>
